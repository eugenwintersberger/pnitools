#include "NXObjectPath.hpp"

//-----------------------------------------------------------------------------
NXObjectPath::NXObjectPath(): _fname(""), _opath(""), _attrname("") {}

//-----------------------------------------------------------------------------
NXObjectPath::NXObjectPath(const String &path):
    _fname(""),
    _opath(""),
    _attrname("")
{
...
//-----------------------------------------------------------------------------
NXObjectPath::NXObjectPath(const String &f,const String &p,const String &a):
    _fname(f),
    _opath(p),
    _attrname(a)
{}
