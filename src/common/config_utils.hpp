...
Checks if the configuration passed to this function includes a help request und
returns true if this is the case. The function assumes that the configuration
has a boolean option named "help". 
...
This function parsers the command line options provided by the user and stores
the results in config. If an error occurs the function return true, false
otherwise. 
\code{.cpp}
