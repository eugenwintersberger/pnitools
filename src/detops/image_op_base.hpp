...
The former ones alter the input image while the latter ones do not. Virtually
all accumulative operations belong to the latter class of operations. 
Image operations like darkfield subtraction and flatfield correction belong to
the former ones. Thus scalar operations are typically the last ones after a chain
of 
*/
class image_op_base
{
    ...
    public:
        ...
        Performs the operation on the. We do not alter the original image but
        rather store the result.
        */
        ...
        */
        ...
        Set the result. This can be used to set an initial value for the result. 
