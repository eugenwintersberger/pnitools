...
{
    //create channel data
    channel_1 = array_type::create(shape_t{{nchannels}});
    create_range(channel_1.begin(),channel_1.end(),0,1);
    channel_2 = channel_1;
    channel_3 = channel_1;

    //create payload data
    data_1 = array_type::create(shape_t{{nchannels}});
    data_2 = array_type::create(shape_t{{nchannels}});
    data_3 = array_type::create(shape_t{{nchannels}});
