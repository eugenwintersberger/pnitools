...
class mcaops_min_test(unittest.TestCase):
    ...
    def get_total_result(self):
        result =  check_output([common.command,common.base_opt,
                      common.mca_opt,"min","fiodata.nxs"])
        return result
...
class mcaops_min_test_fio(mcaops_min_test):
    ...
    def get_total_result(self):
        result =  check_output([common.command,"min",
                                common.files1,common.files2,
                               ])
        return result

    def get_roi1_result(self):
        return check_output([common.command,common.roi1_opt,"min",
                             common.files1,common.files2])

    def get_roi2_result(self):
        return check_output([common.command,common.roi2_opt, "min",
                             common.files1,common.files2])
...
class mcaops_min_test_stdio(mcaops_min_test):
    ...
    def get_total_result(self):
        ...
        for input_file in common.input_files:
            ...
            result += check_output([common.command,"min"],stdin=tail.stdout)
    ...
    def get_roi1_result(self):
        ...
        for input_file in common.input_files:
            tail = Popen(["tail","-n2048",input_file],stdout=PIPE)
            result += check_output([common.command,common.roi1_opt,"min"],
                                    stdin=tail.stdout)
    ...
    def get_roi2_result(self):
        ...
        for input_file in common.input_files:
            tail = Popen(["tail","-n2048",input_file],stdout=PIPE)
            result += check_output([common.command,common.roi2_opt,"min"],
                                    stdin=tail.stdout)
